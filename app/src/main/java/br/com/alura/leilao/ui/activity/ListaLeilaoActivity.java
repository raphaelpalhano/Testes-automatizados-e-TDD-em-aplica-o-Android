...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        Leilao foguete = new Leilao("Crew Dragon");
        foguete.propoe(new Lance(new Usuario("XinJuan"), 10000000.0));
        foguete.propoe(new Lance(new Usuario("Loft Felto"), 1932222.0));
        foguete.propoe(new Lance(new Usuario("Loft Felto"), 2932222.0));

        Leilao fusca = new Leilao("fusca");
        fusca.propoe(new Lance(new Usuario("Ruviana"), 1500.0));
